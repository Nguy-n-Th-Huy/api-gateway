    ...
    build: (settings: AuthSettings) => (
      <OAuthSection
        ...
        defaultValues={{
          ...
          TelegramBotIntegrationEnabled: settings.TelegramBotIntegrationEnabled,
          TelegramBotServiceKey: settings.TelegramBotServiceKey,
          TelegramBotCallbackURL: settings.TelegramBotCallbackURL,
          TelegramBotCallbackSecret: settings.TelegramBotCallbackSecret,
          TelegramHandleRequired: settings.TelegramHandleRequired,
