...
export function IconCard({ iconName, size = 32, className }: IconCardProps) {
  return (
    ...
    >
      <div className='from-warning/10 to-warning/0 absolute -top-8 left-1/2 h-16 w-32 -translate-x-1/2 rounded-full bg-radial opacity-0 blur-xl transition-opacity duration-500 group-hover/card:opacity-100' />
