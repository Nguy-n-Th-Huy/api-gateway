  ...
  return (
    <div className='group/feature text-foreground flex flex-col gap-4 p-4'>
      ...
      <div className='flex items-center self-start'>
        <div className='from-warning/20 to-warning/10 ring-warning/20 group-hover/feature:ring-warning/40 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br shadow-inner ring-1 transition-all duration-300 group-hover/feature:scale-110'>
          {icon}
        </div>
      </div>
      {/* Title */}
