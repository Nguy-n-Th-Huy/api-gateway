...
const (
	...
	MsgUserBindingRemovalWouldLockAccount    = "user.binding_removal_would_lock_account"
	MsgUserTelegramHandleRequired            = "user.telegram_handle_required"
	MsgUserTelegramHandleTooShort            = "user.telegram_handle_too_short"
	MsgUserTelegramHandleTooLong             = "user.telegram_handle_too_long"
	MsgUserTelegramHandleInvalidChars        = "user.telegram_handle_invalid_chars"
	MsgUserTelegramHandleMustStartWithLetter = "user.telegram_handle_must_start_with_letter"
)
...
// Telegram link related messages: the website endpoint that redeems a
// bot-issued link code (specs/telegram/account-link/spec.md).
const (
	MsgTelegramLinkCodeRequired        = "telegram_link.code_required"
	MsgTelegramLinkCodeInvalid         = "telegram_link.code_invalid"
	MsgTelegramLinkAlreadyBound        = "telegram_link.already_bound"
	MsgTelegramLinkAccountAlreadyBound = "telegram_link.account_already_bound"
	MsgTelegramLinkAccountUnusable     = "telegram_link.account_unusable"
	MsgTelegramLinkSessionInvalid      = "telegram_link.session_invalid"
	MsgTelegramLinkInternalError       = "telegram_link.internal_error"
	MsgTelegramLinkSuccess             = "telegram_link.success"
)
...
const (
	...
	MsgOAuthLegacyIdentityMismatch     = "oauth.legacy_identity_mismatch"
	MsgOAuthLegacyIdentityUnverifiable = "oauth.legacy_identity_unverifiable"
)
